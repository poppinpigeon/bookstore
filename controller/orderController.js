...
const order = async (req, res) => {
    ...
    if(authorization instanceof jwt.TokenExpiredError){
        ...
        const {items, delivery, totalQuantity, totalPrice, orderSummary} = req.body;
        ...
        sql = `INSERT INTO orders (book_title, total_quantity, total_price, user_id, delivery_id) 
                VALUES (?, ?, ?, ?, ?)`;
        values = [orderSummary, totalQuantity, totalPrice, authorization.id, delivery_id];
...
const getOrders = async (req, res) => {
    ...
    if(authorization instanceof jwt.TokenExpiredError){
        ...
        let [rows] = await conn.query(sql, [authorization.id]);
